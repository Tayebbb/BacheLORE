...
const Footer = () => (
  <footer className="footer" role="contentinfo">
    <div className="footer-content">
      <span className="footer-copy">© {new Date().getFullYear()} BacheLORE</span>

      <nav className="footer-social" aria-label="Social links">
        <a className="footer-link" href="#" aria-label="Twitter" target="_blank" rel="noopener noreferrer">
        ...
        <a className="footer-link" href="#" aria-label="Facebook" target="_blank" rel="noopener noreferrer">
          <svg width="24" height="24" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <a className="footer-link" href="#" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
          <svg width="24" height="24" viewBox="0 0 24 24" aria-hidden="true">
